    ...
    routing {
        ...
        authenticate("auth-jwt") {
            ...
            get("/user/{username}") {
                ...
                call.respond(LoginInfo(username = user.username, password = "", email = user.email, user.friends?.map { LoginInfo(username = it.username, null,null,null) }?.toMutableList()))
            }
            ...
            put("user") {
                ...
                if (username == call.parameters["username"]) {
                    Singletons.Users.findOne(filter)
                        ?: return@put call.response.status(HttpStatusCode.NoContent)
            ...
            post("/createlobby") {
                ...
                call.respond(hashMapOf("lobby" to lobby.lobbyCode))
            }
